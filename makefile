...
push_test:
	lftp ftp://jul.legall:loesfofr@ftpperso.free.fr -e "mirror -e --ignore-time -R _site thaos-avocat; put -O thaos-avocat/ free_access/.htaccess; put -O thaos-avocat/ free_access/.htpasswd; quit"
